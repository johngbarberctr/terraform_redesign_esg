...
resource "mso_schema_site_anp" "site_anp_apic1_stretched" {
  schema_id     = data.mso_schema.existing.id
  template_name = "L2_Stretched"
...
resource "mso_schema_site_anp" "site_anp_apic2_stretched" {
  schema_id     = data.mso_schema.existing.id
  template_name = "L2_Stretched"
...
# Site EPGs - apic1 (showing all 29)
...
# Site EPGs - apic2 (all 29 - identical structure for K site)
...
resource "mso_schema_site_anp" "site_anp_apic1_g_specific" {
  schema_id     = data.mso_schema.existing.id
  template_name = "G-Specific_Only"
  site_id       = data.mso_site.apic1.id
  anp_name      = mso_schema_template_anp.appprof_rcc_g_specific.name
...
resource "mso_schema_site_anp" "site_anp_apic2_k_specific" {
  schema_id     = data.mso_schema.existing.id
  template_name = "K-Specific_Only"
  site_id       = data.mso_site.apic2.id
  anp_name      = mso_schema_template_anp.appprof_rcc_k_specific.name
...
resource "mso_schema_site_anp" "site_anp_apic1_non_stretched" {
  schema_id     = data.mso_schema.existing.id
  template_name = "L2_Non-Stretched"
  site_id       = data.mso_site.apic1.id
  anp_name      = mso_schema_template_anp.appprof_rcc_non_stretched.name
...
resource "mso_schema_site_anp" "site_anp_apic2_non_stretched" {
  schema_id     = data.mso_schema.existing.id
  template_name = "L2_Non-Stretched"
  site_id       = data.mso_site.apic2.id
  anp_name      = mso_schema_template_anp.appprof_rcc_non_stretched.name
...
# L2_Stretched BDs - apic1 Site (29 BDs)
...
# L2_Stretched BDs - apic2 Site (29 BDs - same structure)
...
# L2_Stretched EPGs - apic1 (29 domains)
...
# L2_Stretched EPGs - apic2 (29 domains - identical structure)
...
# L2_Non-Stretched EPG Domains - apic1
...
# L2_Non-Stretched EPG Domains - apic2
