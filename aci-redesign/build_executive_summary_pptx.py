...
def decisions_slide():
    ...
    rows = [
        ...
        ["ESG / micro-segmentation roadmap",
         "Initial design uses vzAny permit-all. ESG-based tightening "
         "is deferred until the Terraform module supports them.",
         "Security + Network",
         "Tracked as a follow-up; lab runs vzAny today without issue."],
    ]
...
def ask_slide():
    ...
    items = [
        ...
        ("Acknowledge deferred items",
         "L3Out reorganisation and ESG-based micro-segmentation are "
...
def references_slide():
    ...
    rows = [
        ...
        ["NDO schema (single source of truth)",
         ...
         "2 VRFs, 39 BDs, 39 EPGs, vzAny + 2 contracts. "
